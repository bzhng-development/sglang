...
suites = {
    "per-commit": [
        ...
        TestFile("quant/test_fp8_kvcache.py", 8),
        ...
        TestFile("test_beam_search.py", 60),
        TestFile("test_create_kvindices.py", 2),
        TestFile("test_chunked_prefill.py", 313),
        TestFile("test_custom_allreduce.py", 60),
        TestFile("test_double_sparsity.py", 60),
        ...
        TestFile("test_get_weights_by_name.py", 60),
        TestFile("test_gguf.py", 60),
        ...
        TestFile("test_session_control.py", 60),
