    ...
    def stream_output_generation(
        ...
        for req in reqs:
            ...
            if should_output:
                ...
                # Optimization: emit a single int instead of a one-element list for the common case
                # This eliminates 1024+ list allocations per decode cycle at batch size 1024
                num_new_tokens = len(req.output_ids) - send_token_offset
                if num_new_tokens == 1:
